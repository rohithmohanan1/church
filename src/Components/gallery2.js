...
export default function Gallery2 () {
	return (
		<div className='gallery2_gallery2'>
			...
			<img className='Subtract' src = {ImgAsset.gallery2_Subtract} />
			<img className='Subtract_1' src = {ImgAsset.gallery2_Subtract_1} />
			<img className='Subtract_2' src = {ImgAsset.gallery2_Subtract_2} />
			<img className='Subtract_3' src = {ImgAsset.gallery2_Subtract_3} />
			...
			<span className='Name_9'>Name</span>
			<span className='Name_10'>Name</span>
			<span className='Name_11'>Name</span>
			...
			<span className='PHOTO_8'>PHOTO</span>
			<span className='PHOTO_9'>PHOTO</span>
			<span className='PHOTO_10'>PHOTO</span>
			<span className='PHOTO_11'>PHOTO</span>
		</div>
	)
}